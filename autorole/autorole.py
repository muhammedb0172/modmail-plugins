...
class Autorole(Cog):
    ...
    More info: [click here](https://github.com/muhammedb0172/modmail-plugins/tree/master/autorole)
    """
    ...
    async def set_(self, ctx, role: discord.Role):
        ...
        embed = discord.Embed(
            title="Autorole",
            url="https://github.com/muhammedb0172/modmail-plugins/blob/master/autorole",
